...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
     ...
     //   agendaEventos.adicionarEvento(LocalDate.of(2023, 9, 22), "Evento 4", "Atracao 4");
        agendaEventos.adicionarEvento(LocalDate.of(2023, 9, 23), "Evento 5", "Atracao 5");
        agendaEventos.adicionarEvento(LocalDate.of(2024, 1, 25), "Evento 6", "Atracao 6");
